...
package talend_191203.primer_job_0_1;
...
public class primer_job implements TalendJob {
	...
	JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_mBAZsBW0Eeqs_a2OF-L5JQ", "0.1");
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_TALEND_191203_primer_job = new byte[0];
		static byte[] commonByteArray_TALEND_191203_primer_job = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TALEND_191203_primer_job.length) {
					if (length < 1024 && commonByteArray_TALEND_191203_primer_job.length == 0) {
						commonByteArray_TALEND_191203_primer_job = new byte[1024];
					} else {
						commonByteArray_TALEND_191203_primer_job = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TALEND_191203_primer_job, 0, length);
				strReturn = new String(commonByteArray_TALEND_191203_primer_job, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TALEND_191203_primer_job) {
...
///////////////////////		
								...
								if (out1.GenreId != null) { //
									...
									strBuffer_tLogRow_1.append(String.valueOf(out1.GenreId));
								...
								if (out1.Name != null) { //
									...
									strBuffer_tLogRow_1.append(String.valueOf(out1.Name));
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = primer_job.class.getClassLoader()
					.getResourceAsStream("talend_191203/primer_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 64782 characters generated by Talend Cloud Big Data on the 3 de diciembre de
 * 2019 11:08:43 CET
 ************************************************************************************************/